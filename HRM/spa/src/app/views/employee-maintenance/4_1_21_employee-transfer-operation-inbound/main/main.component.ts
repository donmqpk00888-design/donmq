...
export class MainComponent extends InjectBase implements OnInit {
  ...
  param: EmployeeTransferOperationInboundParam = <EmployeeTransferOperationInboundParam>{};
  ...
  effectiveStatus: KeyValuePair[] = [
    { key: 'Y', value: 'EmployeeInformationModule.EmployeeTransferOperationInbound.GraduationYes' },
    { key: 'N', value: 'EmployeeInformationModule.EmployeeTransferOperationInbound.GraduationNo' },
    { key: '', value: 'EmployeeInformationModule.EmployeeTransferOperationInbound.All' },
  ];
  ...
  ngOnDestroy(): void {
    this._service.setParamSearch(<EmployeeTransferOperationInboundMainMemory>{
      param: this.param,
  ...
  clear() {
    this.param = <EmployeeTransferOperationInboundParam>{ effectiveStatus: '' };
    this.data = [];
  ...
  edit(item: EmployeeTransferOperationInboundDto) {
