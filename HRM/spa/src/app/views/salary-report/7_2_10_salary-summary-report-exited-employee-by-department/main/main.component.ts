...
import { S_7_2_10_SalarySummaryReportExitedEmployeeByDepartmentService } from "@services/salary-report/s_7_2_10_salary-summary-report-exited-employee-by-department.service";
...
export class MainComponent extends InjectBase implements OnInit {
  ...
  totalRows: number = 0;
  param: SalarySummaryReportExitedEmployeeByDepartmentParam = <SalarySummaryReportExitedEmployeeByDepartmentParam>{
    permission_Group: [],
  }
  ...
  transfers: KeyValuePair[] = [
    { key: 'Y', value: 'SalaryReport.SalarySummaryReportExitedEmployeeByDepartment.Transfer' },
    { key: 'N', value: 'SalaryReport.SalarySummaryReportExitedEmployeeByDepartment.NoTransfer' },
    { key: 'All', value: 'SalaryReport.SalarySummaryReportExitedEmployeeByDepartment.All' }
  ];
  ...
  constructor(private service: S_7_2_10_SalarySummaryReportExitedEmployeeByDepartmentService) {
    super()
  ...
  ngOnDestroy(): void {
    this.service.setSource(<SalarySummaryReportExitedEmployeeByDepartmentSource>{
      param: this.param,
  ...
  clear(){
    ...
    this.totalRows = 0;
    this.param = <SalarySummaryReportExitedEmployeeByDepartmentParam> {
      permission_Group: [],
    }
  }
