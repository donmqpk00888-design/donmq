...
import { S_7_2_12_MonthlySalaryTransferDetailsService } from '@services/salary-report/s-7-2-12-monthly-salary-transfer-details.service';
...
export class MainComponent extends InjectBase implements OnInit, OnDestroy {
  ...
  param: MonthlySalaryTransferDetailsParam = <MonthlySalaryTransferDetailsParam>{}
  ...
  programCode: string = '';
  constructor(private service: S_7_2_12_MonthlySalaryTransferDetailsService) {
    super();
  ...
  ngOnDestroy(): void {
    this.service.setSource(<MonthlySalaryTransferDetailsSource>{
      param: this.param,
  ...
  clear() {
    ...
    this.totalRows = 0;
    this.param = <MonthlySalaryTransferDetailsParam>{
      permission_Group: [],
    }
  }
