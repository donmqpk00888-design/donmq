...
namespace API._Services.Interfaces.SalaryReport
{
    ...
    public interface I_7_2_16_DownloadPersonnelDatatoEXCEL 
    {
        Task<OperationResult> GetTotalRows(D_7_2_16_DownloadPersonnelDatatoEXCELParam param);
        Task<OperationResult> Download(D_7_2_16_DownloadPersonnelDatatoEXCELParam param);
