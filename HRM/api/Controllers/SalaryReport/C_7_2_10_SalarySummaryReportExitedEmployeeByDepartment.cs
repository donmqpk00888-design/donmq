...
{
    public class C_7_2_10_SalarySummaryReportExitedEmployeeByDepartmentController : APIController
    {
        private readonly I_7_2_10_SalarySummaryReportExitedEmployeeByDepartment _service;

        public C_7_2_10_SalarySummaryReportExitedEmployeeByDepartmentController(I_7_2_10_SalarySummaryReportExitedEmployeeByDepartment service)
        {
            _service = service;
        }

        [HttpGet("GetTotalRows")]
        public async Task<IActionResult> GetTotalRows([FromQuery] SalarySummaryReportExitedEmployeeByDepartmentParam param)
        {
        ...
        [HttpGet("Download")]
        public async Task<IActionResult> Download([FromQuery] SalarySummaryReportExitedEmployeeByDepartmentParam param)
        {
