...
{
    public class C_7_2_16_DownloadPersonnelDatatoEXCELController : APIController
    {
        private readonly I_7_2_16_DownloadPersonnelDatatoEXCEL _service;

        public C_7_2_16_DownloadPersonnelDatatoEXCELController(I_7_2_16_DownloadPersonnelDatatoEXCEL service)
        {
            _service = service;
        }

        [HttpGet("GetTotalRows")]
        public async Task<IActionResult> GetTotalRows([FromQuery] D_7_2_16_DownloadPersonnelDatatoEXCELParam   param)
        {
        ...
        [HttpGet("Download")]
        public async Task<IActionResult> Download([FromQuery] D_7_2_16_DownloadPersonnelDatatoEXCELParam   param)
        {
